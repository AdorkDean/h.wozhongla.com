  ...
  grunt.initConfig({
    ...
    copy: {
      dist: {
        ...
        files: [
          {expand: true, cwd: '_dist/', src: ['*.js'], dest: '_dist/'}
        ]
      },
      cdnjs: {
        files: [
          {expand: true, cwd: '_dist/', src: ['*.js'], dest: '_dist/cdnjs'}
        ]
      },
      components: {
        files: [
          {expand: true, cwd: 'components/', src: ['**'], dest: '_dist/components'},
          {expand: true, cwd: '_dist/', src: ['*.js'], dest: '_dist/components'}
        ]
      }
    },
    ...
    requirejs: {
      ...
      dist: {
        options: {
          name: "handlebars",
          out: "_dist/handlebars.amd.js"
        }
      },
      runtime: {
        options: {
          name: "handlebars.runtime",
          out: "_dist/handlebars.runtime.amd.js"
        }
      }
    },
