...
define("wzlh5/1.0.0/userLotteryResult",["jquery/2.1.1/jquery","wzlh5/1.0.0/ac","handlebars/1.3.0/dist/cjs/handlebars",'wzlh5/1.0.0/until',"wzlh5/1.0.0/cp","wzlh5/1.0.0/ui"],function (require, exports, module) {
                ...
                if (!$('#reg-check').prop('checked')) {
                    ...
                    actions.register(data, function(re) {
                        ...
                        if (re.resultCode == '200') {
                            ...
                            window.location.href = "http://www.wozhongla.com/down/download.html";
                        } else {
                            setTimeout(function (){
                                dialog('tips',re.data);
                            },2000);
