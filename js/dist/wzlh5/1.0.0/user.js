...
define("wzlh5/1.0.0/user",["jquery/2.1.1/jquery","wzlh5/1.0.0/ac","handlebars/1.3.0/dist/cjs/handlebars",'wzlh5/1.0.0/until',"wzlh5/1.0.0/cp","wzlh5/1.0.0/ui"],function (require, exports, module) {
                    ...
                    if (!$('#reg-check').prop('checked')) {
                        ...
                        actions.register(data, function(re) {
                            ...
                            if (re.resultCode == '200') {
                                ...
                                window.location.href = "registerok.html?" + 'userName=' +
                                    re.data.userName + '&userMobile=' + re.data.userMobile||"";
                            } else {
                                setTimeout(function (){
                                    dialog('tips',re.data);
                                },2000);
            ...
            function ucenter() {
                ...
                action.queryUserAllInfo({},function (re){
                    if(re.resultCode == '200' && re.data != '用户没有登录'){
                        ...
                        re.data.u_cj = parseInt(re.data.accountInfo[1]['balance']);
						re.data.u_hb = re.data.accountInfo[2]['balance'];
